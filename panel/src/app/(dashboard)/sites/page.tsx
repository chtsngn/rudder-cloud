    ...
    <div className="max-w-7xl mx-auto space-y-8 pb-12">
      ...
      <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4 pb-5 border-b border-slate-200/80">
        <div>
          <div className="flex items-center gap-3">
            ...
            {sites !== null && (
              <span className="rounded-full bg-[#580619]/10 border border-[#580619]/20 px-3 py-0.5 text-xs font-bold text-[#580619] font-mono">
      ...
      {sites && sites.length > 0 && (
        <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
          <div className="flex items-center gap-3.5 p-4 rounded-2xl border border-slate-200/90 bg-white shadow-xs">
            <div className="size-10 rounded-xl bg-emerald-50 border border-emerald-200/80 flex items-center justify-center text-emerald-600">
          ...
          <div className="flex items-center gap-3.5 p-4 rounded-2xl border border-slate-200/90 bg-white shadow-xs">
            <div className="size-10 rounded-xl bg-slate-100 border border-slate-200 flex items-center justify-center text-slate-600">
          ...
          <div className="flex items-center gap-3.5 p-4 rounded-2xl border border-slate-200/90 bg-white shadow-xs">
            <div className="size-10 rounded-xl bg-red-50 border border-red-200/80 flex items-center justify-center text-red-600">
      ...
      <div className="flex flex-col md:flex-row items-stretch md:items-center justify-between gap-3.5 p-3 rounded-2xl border border-slate-200/90 bg-white shadow-xs">
        {/* Arama Kutusu */}
        <div className="relative flex-1">
          ...
          <Input
            ...
            className="pl-9.5 h-10 rounded-xl border-slate-200 font-mono text-xs focus-visible:ring-[#580619]/20"
          />
        </div>
